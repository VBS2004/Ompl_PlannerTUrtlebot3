...
#include </opt/ros/humble/include/tf2_geometry_msgs/tf2_geometry_msgs/tf2_geometry_msgs.hpp>
 ...
 void plan(const rclcpp::Publisher<nav_msgs::msg::Path>::SharedPtr& path_publisher)
 {
	...
	start[0] = -4; // Set X-coordinate of the goal
	start[1] = -5; // Set Y-coordinate of the goal
	...
	std::cout << goal;
	goal[0] = -7; // Set X-coordinate of the goal
	goal[1] = -8; // Set Y-coordinate of the goal
	// Set the orientation if applicable (e.g., for SE3 planning)
	goal[2] = 0;
 ...
 {
    rclcpp::init(argc, argv);#include <builtin_interfaces/msg/time.hpp>
#include <iomanip>
#include <ompl/base/SpaceInformation.h>
#include <ompl/base/spaces/SE2StateSpace.h>
#include <ompl/geometric/planners/rrt/RRTConnect.h>
