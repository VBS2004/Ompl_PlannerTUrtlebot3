    ...
    *******************************************************************************"""
    ...
    def generate_path(self):
        ...
        # Access the position and orientation of the pose
            input_x, input_y, input_theta =position.x,position.y,theta
            self.goal_pose_x = input_x
            self.goal_pose_y = input_y
            self.goal_pose_theta = input_theta
            self.get_logger().info(f"Going to {self.goal_pose_x},{self.goal_pose_y} .")
            # Step 1: Turn
            if self.step == 1:
